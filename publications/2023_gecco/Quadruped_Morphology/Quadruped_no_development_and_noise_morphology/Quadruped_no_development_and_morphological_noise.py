...
triggen = 60            # Generation at which the application of noise ends.
...
def loadRobot ():
    ...
    # Section for making the robot to change its morphology due to the noise application on the extensible joints.
    if datah.contGen < triggen:
        finalLenght = maxLength + rd.gauss(mu, sigma)
    else:
