...
def main():
    ...
    coef = np.pi / 180.0
    coef1 = 0.5*np.pi / 180.0

    datah.output_range = [-10.0*coef1, 10.0*coef1,  -10.0*coef1, 10.0*coef1, -50.0*coef1,     10.0*coef1,  25.0*coef1,   85.0*coef1,  -65.0*coef1, -5.0*coef1, -30.0*coef1,   30.0*coef1,  -10.0*coef1,  10.0*coef1, -10.0*coef1,  10.0*coef1, -50.0*coef1,    10.0*coef1, 25.0*coef1,   85.0*coef1,  -65.0*coef1,-5.0*coef1,  -30.0*coef1, 30.0*coef1,  -40.0*coef1,  40.0*coef1,  -40.0*coef1, 40.0*coef1]
