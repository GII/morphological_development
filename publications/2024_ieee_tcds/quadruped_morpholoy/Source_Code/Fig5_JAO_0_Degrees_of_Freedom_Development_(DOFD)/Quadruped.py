...
def main():
    ...
    coef = np.pi/180.0
    datah.output_range = [-90.0*coef, 90.0*coef, 0.0*coef, 0.0*coef, -90.0*coef, 90.0*coef, 0.0*coef, 0.0*coef, -90.0*coef, 90.0*coef, 0.0*coef, 0.0*coef, -90.0*coef, 90.0*coef, 0.0*coef, 0.0*coef]
