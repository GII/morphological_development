...
def run_population_evolution (genIndex):
    ...
    for generation in range(0, generations):
        ...
        print('Intermediate time:', time_str)  # print time in desired format
...
def main():
    ...
    coef = np.pi/180.0
    #                          arm_joint0      ,       leg_joint_0     ,      arm_joint1      ,       leg_joint1      ,      arm_joint3      ,       leg_joint3      ,      arm_joint4      ,       leg_joint4                           ,
    datah.output_range = [-90.0*coef, 90.0*coef, lower_lim*coef, upper_lim*coef, -90.0*coef, 90.0*coef, lower_lim*coef, upper_lim*coef, -90.0*coef, 90.0*coef, lower_lim*coef, upper_lim*coef, -90.0*coef, 90.0*coef, lower_lim*coef, upper_lim*coef]

    print (' ')
    print ('--- Start Experiment ---')
    now = datetime.datetime.now()  # get current time
    time_str = now.strftime("%H:%M:%S")  # format time as HH:MM:SS
    print('Start time:', time_str)  # print time in desired format
    print (' ')
    ...
    now = datetime.datetime.now()  # get current time
    time_str = now.strftime("%H:%M:%S")  # format time as HH:MM:SS
    print('End time:', time_str)  # print time in desired format
    print (' ')
